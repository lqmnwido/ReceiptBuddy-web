      ...
      {summary && (
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white rounded-xl border p-4">
            ...
            <p className="text-2xl font-bold text-primary">RM {summary.total.toFixed(2)}</p>
          </div>
          <div className="bg-white rounded-xl border p-4">
          ...
          <div className="bg-white rounded-xl border p-4">
            ...
            <p className="text-2xl font-bold">RM {summary.average.toFixed(2)}</p>
          </div>
        </div>
      )}
          ...
          <tbody>
            {expenses.map((e: any) => (
              <tr key={e.id} className="border-b last:border-0 hover:bg-gray-50">
                ...
                <td className="p-3 text-sm text-right font-medium">RM {e.amount.toFixed(2)}</td>
              </tr>
            ))}
          </tbody>
        </table>
